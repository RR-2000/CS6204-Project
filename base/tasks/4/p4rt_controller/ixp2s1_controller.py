...
AS3_PORT = 2
AS4_PORT = 3
AS2_SWITCH_INTERFACE = "ixp2s1-eth1"
AS2_ROUTER_MAC = "f0:00:0a:01:02:02"
AS3_ROUTER_MAC = "f0:00:0a:01:03:02"
...
async def main():
    ...
    logger.info("Starting MAC learning controller for ixp2s1")
