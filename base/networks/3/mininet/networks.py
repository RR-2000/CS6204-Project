    ...
    def build(
        ...
        **params
        ...
        hosts_mac_addresses["as1r1"] = {
            "as1r1-eth0": "f0:00:0a:01:01:00",
            "as1r1-eth1": "f0:00:0a:01:01:01",
        }
        hosts_mac_addresses["as2r1"] = {
            "as2r1-eth0": "f0:00:0a:01:02:00",
            "as2r1-eth1": "f0:00:0a:01:02:01",
            "as2r1-eth2": "f0:00:0a:01:02:02",
        }
        hosts_mac_addresses["as3r1"] = {
            "as3r1-eth0": "f0:00:0a:01:03:00",
            "as3r1-eth1": "f0:00:0a:01:03:01",
            "as3r1-eth2": "f0:00:0a:01:03:02",
        }
        hosts_mac_addresses["as4r1"] = {
            "as4r1-eth0": "f0:00:0a:01:04:00",
            "as4r1-eth1": "f0:00:0a:01:04:01",
            # "as4r1-eth2": "f0:00:0a:01:04:02",
        }

        hosts_mac_addresses["as1h1"] = {"as1h1-eth0": "f0:00:0a:00:01:00"}
        hosts_mac_addresses["as1h2"] = {"as1h2-eth0": "f0:00:0a:00:01:01"}
        hosts_mac_addresses["as2h1"] = {"as2h1-eth0": "f0:00:0a:00:02:00"}
        hosts_mac_addresses["as2h2"] = {"as2h2-eth0": "f0:00:0a:00:02:01"}
        hosts_mac_addresses["as3h1"] = {"as3h1-eth0": "f0:00:0a:00:03:00"}
        hosts_mac_addresses["as3h2"] = {"as3h2-eth0": "f0:00:0a:00:03:01"}
        hosts_mac_addresses["as4h1"] = {"as4h1-eth0": "f0:00:0a:00:04:00"}
        hosts_mac_addresses["as4h2"] = {"as4h2-eth0": "f0:00:0a:00:04:01"}
        ...
        as2r1 = self.addNode(
            ...
            configCmds=(
                ...
                [
                    ...
                    HelperFunctions.generate_set_static_arp_command("10.0.4.1", hosts_mac_addresses["as4r1"]["as4r1-eth1"]),
                ]
            ),
        )
        as3r1 = self.addNode(
        ...
        as4r1 = self.addNode(
            ...
            configCmds=(
                ...
                [
                    HelperFunctions.generate_add_loopback_interface_ip_command("10.100.4.1/32"),
                    HelperFunctions.generate_set_static_arp_command("10.0.4.2", hosts_mac_addresses["as2r1"]["as2r1-eth2"]),
                    HelperFunctions.generate_set_static_arp_command("10.0.4.3", hosts_mac_addresses["as3r1"]["as3r1-eth2"]),
                ]
            ),
        )
        ...
        as4s1 = self.addSwitch("as4s1", cls=OVSSwitch)

        as1h1 = self.addHost(
            "as1h1", cls=Client,
            configCmds=(
                HelperFunctions.generate_set_interface_mac_commands(hosts_mac_addresses["as1h1"]) +
                [HelperFunctions.generate_set_default_route_command("10.1.0.1")]
            ),
        )
        as1h2 = self.addHost(
            "as1h2", cls=Client,
        ...
        as2h1 = self.addHost(
            ...
            configCmds=(
                ...
                [HelperFunctions.generate_set_default_route_command("10.2.0.1")]
            ),
        )
        as2h2 = self.addHost(
            "as2h2", cls=Client,
        ...
        as3h1 = self.addHost(
            ...
            configCmds=(
                ...
                [HelperFunctions.generate_set_default_route_command("10.3.0.1")]
            ),
        )
        as3h2 = self.addHost(
            "as3h2", cls=Client,
        ...
        as4h1 = self.addHost(
            ...
            configCmds=(
                ...
                [HelperFunctions.generate_set_default_route_command("10.4.0.1")]
            ),
        )
        as4h2 = self.addHost(
            "as4h2", cls=Client,
        ...
        self.addLink(as1h2, as1s1, intfName1="as1h2-eth0", params1={"ip": "10.1.0.102/24"}, intfName2="as1s1-eth2")

        # AS2 internal
        self.addLink(as2r1, as2s1, intfName1="as2r1-eth0", params1={"ip": "10.2.0.1/24"}, intfName2="as2s1-eth0")
        self.addLink(as2h1, as2s1, intfName1="as2h1-eth0", params1={"ip": "10.2.0.101/24"}, intfName2="as2s1-eth1")
        self.addLink(as2h2, as2s1, intfName1="as2h2-eth0", params1={"ip": "10.2.0.102/24"}, intfName2="as2s1-eth2")

        # AS3 internal
        self.addLink(as3r1, as3s1, intfName1="as3r1-eth0", params1={"ip": "10.3.0.1/24"}, intfName2="as3s1-eth0")
        self.addLink(as3h1, as3s1, intfName1="as3h1-eth0", params1={"ip": "10.3.0.101/24"}, intfName2="as3s1-eth1")
        self.addLink(as3h2, as3s1, intfName1="as3h2-eth0", params1={"ip": "10.3.0.102/24"}, intfName2="as3s1-eth2")

        # AS4 internal
        self.addLink(as4r1, as4s1, intfName1="as4r1-eth0", params1={"ip": "10.4.0.1/24"}, intfName2="as4s1-eth0")
        self.addLink(as4h1, as4s1, intfName1="as4h1-eth0", params1={"ip": "10.4.0.101/24"}, intfName2="as4s1-eth1")
        self.addLink(as4h2, as4s1, intfName1="as4h2-eth0", params1={"ip": "10.4.0.102/24"}, intfName2="as4s1-eth2")

        # AS1, AS2, AS3 to SDX
        self.addLink(as1r1, ixp1s1, intfName1="as1r1-eth1", params1={"ip": "10.0.0.1/24"}, intfName2="ixp1s1-eth1")
        ...
        # AS2, AS3, AS4 to SDX2
        self.addLink(as2r1, ixp2s1, intfName1="as2r1-eth2", params1={"ip": "10.0.4.2/24"}, intfName2="ixp2s1-eth1")
        self.addLink(as3r1, ixp2s1, intfName1="as3r1-eth2", params1={"ip": "10.0.4.3/24"}, intfName2="ixp2s1-eth2")
        self.addLink(as4r1, ixp2s1, intfName1="as4r1-eth1", params1={"ip": "10.0.4.1/24"}, intfName2="ixp2s1-eth3")
